...
BUNDLE = BVibratr.lv2
DSP = BVibratr
DSP_SRC = ./src/BVibratr.cpp
GUI = BVibratrGUI
GUI_SRC = ./src/BVibratrGUI.cpp
OBJ_EXT = .so
DSP_OBJ = $(DSP)$(OBJ_EXT)
GUI_OBJ = $(GUI)$(OBJ_EXT)
...
src/BWidgets/build:
	...
	@cd src/BWidgets ; $(MAKE) -s bwidgets CPPFLAGS+=-DBUTILITIES_DICTIONARY_DATAFILE=\"\\\"../../BVibratr_Dictionary.data\\\"\" CXXFLAGS+=-fvisibility=hidden 
	@echo ...done.
