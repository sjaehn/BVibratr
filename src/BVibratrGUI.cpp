...
BVibratrGUI::BVibratrGUI (const char *bundle_path, const LV2_Feature *const *features, PuglNativeView parentWindow) :
	...
	midiNoteCombobox(720, 40, 70, 20, 0, 20, 70, 360, {/* To be filled later */}, 1, URID("/menu")),
	midiNoteScreen (710, 10, 80, 60, URID("/screen")),
	depthIsCcLabel (20, 120, 100, 20, BDICT("Use") + " CC:", URID("/label")),
	depthIsCcCombobox(20, 140, 160, 20, 0, 20, 160, 280, midiCcNames, 1, URID("/menu")),
	...
	osc2ModeCombobox(410, 140, 90, 20, 0, 20, 90, 100, {BDICT("Off"), BDICT("Add"), "FM 1", "PM 1", "AM 1"}, 1, URID("/menu")),
	osc2WaveformLabel (510, 120, 80, 20, BDICT("Waveform"), URID("/label")),
	osc2WaveformCombobox(510, 140, 80, 20, 0, 20, 90, 80, {BDICT("Sine"), BDICT("Triangle"), BDICT("Square"), BDICT("Saw")}, 1, URID("/menu")),
	...
	osc3ModeCombobox(610, 140, 90, 20, 0, 20, 90, 160, {BDICT("Off"), BDICT("Add"), "FM 1", "PM 1", "AM 1", "FM 2", "PM 2", "AM 2"}, 1, URID("/menu")),
	osc3WaveformLabel (710, 120, 80, 20, BDICT("Waveform"), URID("/label")),
	osc3WaveformCombobox(710, 140, 80, 20, 0, 20, 90, 80, {BDICT("Sine"), BDICT("Triangle"), BDICT("Square"), BDICT("Saw")}, 1, URID("/menu")),
